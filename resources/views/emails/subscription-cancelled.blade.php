                    ...
                    <tr>
                        <td style="padding: 36px 32px; color: #3d281d;">
                            ...
                            <p style="font-size: 15px; line-height: 1.6; margin-bottom: 24px; color: #4a382d;">
                                We're writing to confirm that your <strong>{{ $planName }}</strong> subscription has been successfully cancelled.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 18px 20px;">
                                        ...
                                        <table border="0" cellpadding="4" cellspacing="0" width="100%" style="font-size: 14px;">
                                            <tr>
                                                <td width="35%" style="color: #786050; font-weight: 600; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;">Plan Name:</td>
                                                <td style="color: #26160e; font-weight: 600;">{{ $planName }}</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #786050; font-weight: 600; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;">Access Until:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span style="display: inline-block; background-color: #f9ecec; color: #a13d3d; border: 1px solid #ecc9c9; padding: 2px 8px; border-radius: 4px; font-weight: 600; font-size: 12px;">
                                                        Cancelled
                                                    </span>
                                                </td>
                                            </tr>
                            ...
                            <p style="font-size: 14px; line-height: 1.6; color: #4a382d; margin-top: 20px; margin-bottom: 20px;">
                                We're sorry to see you go! As a reminder, you will still have full access to your premium features until the end of your current billing cycle. 
                            </p>

                            <p style="font-size: 14px; line-height: 1.6; color: #4a382d; margin-top: 0px; margin-bottom: 0px;">
