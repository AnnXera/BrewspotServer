...
<head>
    <meta charset="UTF-8">
    <title>Welcome to BrewSpot</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #fffdf9; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #4a2e1a;">
                            <h2 style="margin-top: 0; color: #2c1a0e; font-size: 20px;">You've Been Added as {{ $roleName }}</h2>
                            ...
                            <p style="font-size: 16px; line-height: 1.6; color: #5c3d2e;">
                                You've been added to BrewSpot as a <strong>{{ $roleName }}</strong>. Click the button below to set up your password and access your dashboard.
                            </p>
                            ...
                            <p style="font-size: 13px; line-height: 1.6; color: #a0846c; margin-top: 30px;">
