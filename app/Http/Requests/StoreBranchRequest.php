...
class StoreBranchRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cafe_phonenumber'     => ['required', 'string', 'max:20', 'regex:/^[0-9+\s\-()]+$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'cafe_phonenumber.regex'        => 'Branch phone number must not contain letters and must be a valid phone number.',
